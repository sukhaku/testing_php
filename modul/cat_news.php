...
while($data=mysql_fetch_array($query)){
	echo"<h2><a href=?page=news&id_news=$data[id_news]>$data[title]</a></h2><br>";
	echo"<h5>$data[date_news]</h5><br><br>";
	echo"<p>".substr($data['content_news'], 0,20)."..<a href=?page=news&id_news=$data[id_news]>Readmore</></p><hr>";
}
?>